...
public class EndLocation {
    ...
    private EndLocationAddress address;
    ...
    public EndLocationAddress getAddress() { return address; }
    @JsonProperty("address")
    public void setAddress(EndLocationAddress value) { this.address = value; }
